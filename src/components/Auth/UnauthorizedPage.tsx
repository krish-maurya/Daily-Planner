...
// remove metho pricing and doc from hedder and remove all the company name which is expedia asana like at botom and select better display font and remove clander icon from the name befor milo and also removie the target  and clander and shield logo from the center and the gradient is only in the in center cart and outside is plan black and 